...
/**
 * Bean validation constraint that checks that a configured RabbitMQ queue exists.
 */
@Target({ElementType.TYPE})
@Retention(RUNTIME)
@Constraint(validatedBy = ExistingQueueValidator.class)
@Documented
public @interface ExistingQueue {

    /**
     * The message that indicates a failed validation.
     */
    String MESSAGE_KEY = "com.arassec.igor.message.validation.queue-must-exist";
