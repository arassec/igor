package com.arassec.igor.module.file.service.local;
 ...
 */
@IgorService(type = "com.arassec.igor.service.file.LocalFilesystemFileService")
public class LocalFilesystemFileService extends BaseFileService {
    ...
    public void writeStream(String file, FileStreamData fileStreamData) {
        ...
        try {
            ...
            copyStreams(fileStreamData.getData(), fileOutputStream, fileStreamData.getFileSize());
        } catch (IOException e) {
