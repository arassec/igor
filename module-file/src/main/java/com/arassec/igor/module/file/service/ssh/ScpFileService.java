 ...
 */
@IgorService(type = "com.arassec.igor.service.file.ScpFileService")
public class ScpFileService extends BaseSshFileService {
    ...
    public String read(String file) {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            copyStreams(fileStreamData.getData(), outputStream, fileStreamData.getFileSize());
            outputStream.flush();
    ...
    public void writeStream(String file, FileStreamData fileStreamData) {
        try {
            ...
            copyStreams(fileStreamData.getData(), sshOutputStream, fileStreamData.getFileSize());
    ...
    private void finalize(Session session, Channel channel, OutputStream sshOutputStream, InputStream sshInputStream) {
        try {
            ...
            throw new ServiceException("Could not finalize SSH streams!", e);
        }
    }
