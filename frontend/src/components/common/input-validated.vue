<template>
    <div class="tooltip">
        ...
        <input
            ...
            :disabled="disabled"
            :value="modelValue"
            @input.stop="updateSelf($event.target.value)"
...
export default {
    ...
    props: ["modelValue", "type", "disabled", "propertyId", "parentId", "validationErrors", "isNumber"],
    emits: ["input"],
    model: {
        prop: "text",
        event: "input",
    ...
    methods: {
        ...
        hasValidationErrors() {
            if (this.validationErrors) {
                return (
                    this.parentId in this.validationErrors && this.propertyId in this.validationErrors[this.parentId]
                );
            }
            return false;
        },
