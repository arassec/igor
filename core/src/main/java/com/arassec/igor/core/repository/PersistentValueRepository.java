...
public interface PersistentValueRepository {
     ...
     */
    PersistentValue upsert(String jobId, PersistentValue value);
     ...
     */
    boolean isPersisted(String jobId, PersistentValue value);
     ...
     */
    void cleanup(String jobId, int numEntriesToKeep);
