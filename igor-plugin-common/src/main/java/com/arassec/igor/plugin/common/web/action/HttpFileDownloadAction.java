...
public class HttpFileDownloadAction extends BaseWebAction {
    ...
    public void initialize(String jobId, JobExecution jobExecution) {
        ...
        targetKey = CommonDataKey.DOWNLOADED_FILE.getKey();
    }
    ...
    public List<Map<String, Object>> process(Map<String, Object> data, JobExecution jobExecution) {
        ...
        try {
            ...
            String targetFileWithSuffix = CommonUtils.appendSuffixIfRequired(filename,
                    fileStreamData.getFilenameSuffix(), appendFiletypeSuffix);

            String targetFileWithPath = CommonUtils.combineFilePath(destination, targetFileWithSuffix);
            ...
            actionData.put(CommonDataKey.TARGET_DIRECTORY.getKey(), destination);
