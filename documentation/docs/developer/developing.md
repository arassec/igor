...
To ease development of igor's frontend, which is written in **{{ $themeConfig.igorVueVersion }}**, you should install 
**{{ $themeConfig.igorNodeVersion }}** (or a later version) in addition to **{{ $themeConfig.igorJavaVersion }}**.

To execute the end-to-end tests you have to install [Docker](https://www.docker.com/) as well.
