...
If the timestamp is given as Epoch timestamp, you can use the following special values as 'Timestamp format' parameter:
...
:---|:---
Input | A mustache expression selecting a property from the data item. The property's value is converted into a timestamp and afterwards used for filtering.
