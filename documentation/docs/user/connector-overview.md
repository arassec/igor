...
![connector overview](./images/connector/connector-overview.png)
...
![add connector button](./images/connector/add-connector-button.png) Opens the connector editor to create a new connector.

![import connector](./images/connector/import-connector-button.png) Opens the dialog for importing connectors.
...
![connector-tile](./images/connector/connector-overview-tile.png)

The tile contains the following buttons to modify the connector:

![delete job button](./images/common/delete-button.png) Deletes the connector.

![export job](./images/common/export-button.png) Exports the connector as JSON text file.

![duplicate job](./images/common/duplicate-button.png) Opens the connector editor with a duplicated connector configuration.
