...
/**
 * Bean validation constraint that checks a connector's name.
 */
@Target({ElementType.TYPE})
@Retention(RUNTIME)
@Constraint(validatedBy = UniqueConnectorNameValidator.class)
@Documented
public @interface UniqueConnectorName {
