...
class HttpFileDownloadActionTest extends CommonActionBaseTest {
    ...
    void testDownloadFileNoContentLengthHeader() {
        ...
        assertEquals("filename", getString(result.get(0), "$.actionResult." + CommonDataKey.TARGET_FILENAME.getKey()));
        assertEquals("/target/dir", getString(result.get(0), "$.actionResult." + CommonDataKey.TARGET_DIRECTORY.getKey()));
    ...
    void testDownloadFileWithContentLengthHeader() {
        ...
        assertEquals(1, result.size());
        assertEquals("file", getString(result.get(0), "$.actionResult." + CommonDataKey.TARGET_FILENAME.getKey()));
        assertEquals("/target", getString(result.get(0), "$.actionResult." + CommonDataKey.TARGET_DIRECTORY.getKey()));
    ...
    void testDetermineAndAppendFilenameSuffix() {
        ...
        assertEquals(1, result.size());
        assertEquals("file.json", getString(result.get(0), "$.actionResult." + CommonDataKey.TARGET_FILENAME.getKey()));
        assertEquals("/target", getString(result.get(0), "$.actionResult." + CommonDataKey.TARGET_DIRECTORY.getKey()));
